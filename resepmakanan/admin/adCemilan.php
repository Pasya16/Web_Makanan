    ...
    <a href="adtambah.php" class="p3">+ Tambah Makanan</a>
      ...
      <th class="p3">Opsi &#127887;</th>
        ...
        <td class="p3"><?php echo $d['Langkah']; ?></td>
				<td>
					<a href="adeditt.php?id=<?php echo $d['Id_Resep']; ?>"  class="p3" onclick="return confirm('Apakah Anda yakin ingin mengedit data ini?')">EDIT</a>
					<a href="adhapus.php?id=<?php echo $d['Id_Resep']; ?>"  class="p3" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">HAPUS</a>
				</td>
			</tr>
			<?php 
		}
